<div>
    ...
    <form wire:submit.prevent="saveStructureTab">
        <div class="card border border-info mb-2 mt-2">
            <div class="card-header p-2 text-info">Crear ficha de estructura</div>
            <div class="card-body text-secondary p-2">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <h5>
                            ...
                            <button wire:click="addQuote" class="btn btn-outline-info btn-sm" type="button"
                ...
                <h5>
                    ...
                    <button wire:click="addBrick" class="btn btn-outline-info btn-sm" type="button"
                ...
                <h5>
                    ...
                    <button wire:click="addFormwork" class="btn btn-outline-info btn-sm" type="button"
