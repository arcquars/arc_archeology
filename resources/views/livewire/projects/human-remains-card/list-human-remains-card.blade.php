    ...
    <table class="table table-striped">
        ...
        @forelse ($humanRemainCards as $humanRemainCard)
            <tr>
                ...
                <td class="text-right">
                    <button class="btn btn-sm btn-arqueologia-brown" wire:click="exportPdf({{$humanRemainCard->id}})">
                        <i class="fas fa-file-pdf"></i>
                    </button>
                    <button class="btn btn-sm btn-arqueologia-brown" wire:click="$dispatch('toggle-human-remain-card-view', {humanRemainCardId: {{$humanRemainCard->id}} })">
                        <i class="far fa-eye"></i>
                    </button>
                    <button class="btn btn-sm btn-arqueologia-brown" wire:click="$dispatch('toggle-human-remain-card-update', {humanRemainCardId: {{$humanRemainCard->id}} })">
                        <i class="far fa-edit"></i>
                    </button>
                    @if(auth()->user()->hasRole('admin'))
                        <a href="{{route('projects.show.human.remain.log', ['humanRemainId' => $humanRemainCard->id])}}" target="_blank" class="btn btn-sm btn-arqueologia-brown" title="Registro de cambios" >
