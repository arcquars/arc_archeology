<div>
    ...
    <form wire:submit.prevent="saveStratumCard">
        <div class="card border border-info mb-2 mt-2">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" id="e-equals" class="form-control form-control-sm" wire:model="stratigraphy_equals">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="e-support_provided" class="form-control form-control-sm" wire:model="stratigraphy_support_provided">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="e-covered_by" class="form-control form-control-sm" wire:model="stratigraphy_covered_by">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="e-filling_by" class="form-control form-control-sm" wire:model="stratigraphy_filling_by">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="e-cut_by" class="form-control form-control-sm" wire:model="stratigraphy_cut_by">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" id="e-equivale" class="form-control form-control-sm" wire:model="stratigraphy_equivale">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="e-supported_by" class="form-control form-control-sm" wire:model="stratigraphy_supported_by">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="e-overlaps_or_covers" class="form-control form-control-sm" wire:model="stratigraphy_overlaps_or_covers">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="e-fill_in" class="form-control form-control-sm" wire:model="stratigraphy_fill_in">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="e-cut_to" class="form-control form-control-sm" wire:model="stratigraphy_cut_to">
            ...
            <div class="card-footer bg-transparent border-top border-width-2 text-right p-2">
                <button class="btn btn-sm btn-dark" type="button" wire:click="$dispatch('close-stratum-card-create')">Cerrar</button>
