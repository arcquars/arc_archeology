<div>
    ...
    <form wire:submit.prevent="saveMaterial">
        <div class="card border border-info mb-2 mt-2">
            <div class="card-header p-2 text-info">Crear Material</div>
                ...
                <div class="form-group">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input @error('material_type') is-invalid @enderror" type="radio"  id="imm-ceramica" value="{{ \App\Models\Material::MATERIAL_TYPE_CERAMIC }}"
                               wire:model="material_type" wire:change="showType('{{ \App\Models\Material::MATERIAL_TYPE_CERAMIC }}')"
                        >
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" id="imm-azulejos" value="{{ \App\Models\Material::MATERIAL_TYPE_TILE }}"
                               wire:model="material_type" wire:change="showType('{{ \App\Models\Material::MATERIAL_TYPE_TILE }}')"
                        >
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" id="imm-otros" value="{{ \App\Models\Material::MATERIAL_TYPE_OTHERS }}"
                               wire:model="material_type" wire:change="showType('{{ \App\Models\Material::MATERIAL_TYPE_OTHERS }}')"
                        >
