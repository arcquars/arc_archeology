    ...
    <div class="row">
        ...
        <div class="col-md-3 d-flex flex-column justify-content-end">
            <div class="form-group">
                <button class="btn btn-sm btn-arqueologia-brown" type="button" title="Buscar..."
                        wire:click="applySearch"
                >
                    <i class="fas fa-search"></i>
                </button>
                <button  class="btn btn-sm btn-danger" title="Limpiar filtros de busqueda" type="button"
        ...
        @forelse ($materialRecounts as $material)
            <tr>
                ...
                <td class="text-right">
                    ...
                    <button class="btn btn-sm btn-arqueologia-brown" wire:click="$dispatch('toggleViewMaterialRecount', {materialRecountId: {{$material->id}} })">
                        <i class="far fa-eye"></i>
                    </button>
                    <button class="btn btn-sm btn-arqueologia-brown" wire:click="$dispatch('toggleUpdateMaterialRecount', {materialRecountId: {{$material->id}} })">
