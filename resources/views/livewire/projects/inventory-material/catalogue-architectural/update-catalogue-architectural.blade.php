<div>
    ...
    <form wire:submit.prevent="updateCatalogueArquitectural">
        <div class="card border border-info mb-2 mt-2">
            <div class="card-header p-2 text-info">Editar Elemento arquitectonico</div>
            <div class="card-body text-secondary p-2">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <hr class="bg-info">
                        <div class="row">
                            @foreach($catalogueArchitectural->urlPhotosPublicAttribute() as $url => $pUrl)
                                <div class="col-md-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <hr class="bg-info">
                        <div class="row">
                            @foreach($catalogueArchitectural->urlSketchPublicAttribute() as $url => $pUrl)
                                <div class="col-md-3">
                                    <div class="position-relative d-inline-block">
                                        {{--                                <img src="{{ $pUrl }}" alt="Imagen desde Wasabi" class="img-thumbnail mb-1" />--}}
                                        @if(strcmp($pUrl['type'], 'image') == 0)
