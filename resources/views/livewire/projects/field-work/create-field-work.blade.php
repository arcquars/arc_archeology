<div class="card border border-info mb-2 mt-2">
    <form wire:submit.prevent="saveFieldWork" enctype="multipart/form-data">
        <div class="card-header p-2 text-info">Crear Ficha Estratigrafia mural</div>
            ...
            <div class="row">
                ...
                <div class="col-md-3 form-group">
                    ...
                    <input type="text" class="form-control form-control-sm @error('n_ue') is-invalid @enderror"
                           wire:model="n_ue" id="cfw_n_ue" @if(!$enableUe) disabled @endif
                    >
                    @error('n_ue')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
