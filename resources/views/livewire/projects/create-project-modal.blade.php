<div>
    <div class="modal fade @if($show) show @endif" id="miModal" tabindex="-1" role="dialog" aria-labelledby="miModalLabel" aria-hidden="@if(!$show) true @else false @endif" style="@if($show) display: block; @endif">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group form-group-sm">
                            ...
                            <input type="text" class="form-control form-control-sm @error('name') is-invalid @enderror" id="name" wire:model="name">
                            @error('name')
